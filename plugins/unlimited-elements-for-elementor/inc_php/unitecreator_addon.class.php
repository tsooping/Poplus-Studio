...
class UniteCreatorAddonWork extends UniteElementsBaseUC{
	...
	public function getAdminLabels(){
		...
		elseif(!empty($firstNumberParam))
			$selectedParam = $firstNumberParam;
		elseif(!empty($firstGoodParam))
	...
	private function a__________ACTIONS____________(){
	}

	/**
	 * trigger addon after update action
	 */
	private function triggerAfterUpdateAction(){

		UniteProviderFunctionsUC::doAction(UniteCreatorFilters::ACTION_ADDON_AFTER_UPDATE, $this);
	}

	/**
	 * trigger addon after delete action
	 */
	public function triggerAfterDeleteAction(){

		UniteProviderFunctionsUC::doAction(UniteCreatorFilters::ACTION_ADDON_AFTER_DELETE, $this);
	}
